...
#ifndef C0006_REDIRECT_NSString_h
#define C0006_REDIRECT_NSString_h

@interface C0006_REDIRECT_NSString_bad : NSObject

-(NSHTTPURLResponse*) bad:(NSString*) urlStr request:(NSMutableURLRequest*) request response:(NSHTTPURLResponse *) response;

@end

@interface C0006_REDIRECT_NSString_good : NSObject
